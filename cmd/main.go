...
import (
	...
	"github.com/tabed23/doks-capacity-operator/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "7af8d815.mahy.love",
	...
	if err := (&controller.DoksCapacityOperatorReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "DoksCapacityOperator")
		os.Exit(1)
	}
